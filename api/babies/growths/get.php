...
try {
    ...
    // Get all growths data for the specified baby_id
    $select_query = "SELECT id, detail, age_gap, month FROM babies_growths WHERE baby_id = ?";
    ...
    echo json_encode(msg(1, 200, 'Growths data retrieved successfully.', ['data' => $growthsData]));
} catch (Exception $e) {
